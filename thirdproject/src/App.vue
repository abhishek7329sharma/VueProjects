<template>
  <div id="app">
    ...
    <b-container>
      <div class="main-container pl-4 pr-4 pr-2 pt-3">
        ...
        <b-row class="ml-0 mr-0 justify-content-center">
    ...
    <div id="footer" class="mt-4 pt-2 pb-2">
      <b-row>
        ...
        <b-col class=" mt-2" align="center">
          <button class="right" @click="showModal = true">
            Add item to cart
          </button>
        </b-col>
      </b-row>
